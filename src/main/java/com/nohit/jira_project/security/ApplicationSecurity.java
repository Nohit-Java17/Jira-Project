    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(API_VIEW + LOGIN_VIEW, API_VIEW + TOKEN_VIEW + REFRESH_VIEW,
                        ...
                        CONTACT_VIEW, CONTACT_VIEW + FREE_VIEW, DETAIL_VIEW, DETAIL_VIEW + FREE_VIEW, RATE_VIEW,
                        RATE_VIEW + FREE_VIEW, "css/**")
                .permitAll()
                ...
                .accessDeniedPage(LOGIN_VIEW).and().rememberMe().rememberMeParameter(REMEMBER_ME_PARAM).and()
